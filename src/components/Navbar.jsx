...
const Navbar = () => {
  ...
  return (
    <nav className='w-full flex py-6 justify-between item-center navbar'>
      <img src={logo} alt='Holyentgoldlogo' className='w-[50px] h-[32px] rounded' />
      ...
      <div className='sm:hidden flex flex-1 justify-end items-center'>
        ...
        <div className={`${toggle ? 'flex' : 'hidden'} p-6 bg-golden-gradient absolute top-20 right-0 mx-4 my-2 min-w-[140px] rounded-xl sidebar`}>
